export const SECTIONS = [
  ...
  },
  {
    ...
    title: "System Design",
    fields: [
      { name: "inverter_product_id", label: "Inverter (from catalog)", type: "product-select", category: "inverter" },
      ...
      { name: "battery_product_id", label: "Battery (from catalog)", type: "product-select", category: "battery" },
      ...
      { name: "panel_product_id", label: "Panel (from catalog)", type: "product-select", category: "panel" },
